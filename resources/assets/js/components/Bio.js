      ...
      <div className='box box-padding-top box-padding-bottom box-padding-left-sm'>
        <Media>
          <Media.Left align='top'>
            <img width={64} height={64} alt="thumbnail" src={Router.route(IMAGE_ASSET, {fileName: 'iconmonstr-user-male-thin-240.png'})}/>
          </Media.Left>
          <Media.Body>
            <h2 className='box-text box-padding-left-md'>Quick Bio</h2>
