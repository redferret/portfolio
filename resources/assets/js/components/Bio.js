    ...
    return (
      <div>
        ...
        <p className='box-text box-padding-left-md'>
          ...
          " businesses, my main interest is on building sleek simple single paged web applications that are " +
        ...
        <p className='box-text box-padding-left-md'>
          {"This portfolio is rather new and I intend to start a blog for anyone visiting here to read. " +
           ...
           "and highlighted projects detailed below with links to Git as well."}
        </p>
      </div>
    )
  }
